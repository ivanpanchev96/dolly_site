  ...
  return (
    <Box sx={{ bgcolor: "background.default", pb: { xs: 6, md: 8 } }}>
      <Container maxWidth="lg" sx={{ py: { xs: 4, md: 5 }, px: { xs: 2, sm: 3 } }}>
            ...
            <Stack height="100%" justifyContent="space-between">
              <Stack spacing={2}>
                ...
                <Typography className="project-body" color="text.secondary">
                  Дом за млада двойка, създаден с усещане за английски уют.
                  Зеленият цвят и фрезованите повърхности внасят характер и мекота.
                </Typography>
                <Typography className="project-body" color="text.secondary">
                  Пространствата са ясно обособени за различни активности, но свързани
                  в една спокойна и последователна концепция.
                </Typography>
                <Typography className="project-body" color="text.secondary">
                  Интериор, който не следва тенденции, а създава усещане за истински дом.
                </Typography>
              </Stack>
              <Typography className="project-body" color="text.secondary" sx={{ pt: 2 }}>
                ...
                <br />
                Статус: Реализиран с проджект мениджмънт
              </Typography>
            </Stack>
          </Grid>
        ...
        <ProjectNav currentPath="/projects/home-in-pastel" />
      </Container>
    </Box>
  );
}
